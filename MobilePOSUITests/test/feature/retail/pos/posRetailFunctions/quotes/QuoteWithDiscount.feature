Feature: Create a quote with a discount and convert it

  @PT-1990 @QuoteWithDiscount @Quote @DevelopmentInProgress
  Scenario: Create a quote with a discount and convert it
    ...
    And "Transaction Discount -£10.00" is displayed in "Receipt" list
    ...
    Then "${Sku Product 1}" is displayed in "Receipt" list" list
    And "${Sku Product 1}" is displayed in "Receipt" list" list
    And "Transaction Discount -£10.00" is displayed in "Receipt" list
    ...
    And "${Sku Product 1}" is displayed in "Receipt" list
    And "Transaction Discount -£10.00" is not displayed in "Receipt" list
    And user presses "Discount / Overrides" button
    And user presses "Transaction Discount" button and "Select Reason" page shown
    And user selects "10 % Off" from "Selection List" list
    And user presses "OK" button
    ...
    And receipt display with following details
      ...
      | item | Disc (Transaction Discount,-£10.00                                                                  |
