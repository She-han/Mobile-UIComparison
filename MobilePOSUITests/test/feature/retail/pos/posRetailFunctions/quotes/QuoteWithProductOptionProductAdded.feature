Feature: Convert a quote with a product option product added

  @PT-1972 @QuoteProductOptionProductAdded @Quote @DevelopmentInProgress
  Scenario: Convert a quote with a product option product added
    ...
    And "${Fee Product 1}" is displayed in "Receipt" list
    ...
    And receipt display with following details
      ...
      | item | ${Fee Product 1 Description},£5.0   |
