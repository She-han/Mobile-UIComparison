Feature: Terminal Cashup and Leave

  @PT-150 @TerminalCashManagement @MVP @HN @Support @AUTOMATED @ManualVerification @POS
  Scenario: Terminal Cash Management - Cashup and Leave
    ...
    And user enters "Terminal cashup and leave" into "Cash Management Text Area" field
    And user presses "OK" button and "Terminal Cash Management Select Tender" page shown
    #And user presses "Complete" button and "Cash Management Discrepancy Tender" page shown
