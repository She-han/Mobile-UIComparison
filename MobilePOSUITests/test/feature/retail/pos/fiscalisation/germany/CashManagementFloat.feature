Feature: Cash Management Float on German Fiscal POS

  @PT-2183 @AUTOMATED @Germany @Fiscalisation @FiscalGermany @ManualVerification
  Scenario: Verify the Fiscal Receipt for Cash Management Float on German Fiscal POS 
