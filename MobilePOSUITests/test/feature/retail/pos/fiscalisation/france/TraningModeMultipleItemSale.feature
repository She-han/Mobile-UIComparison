Feature: Normal multiple item sale in Training Mode

  @PT-17386 @Fiscalisation @France @FiscalFranceTrainingMode @No_Printer @AUTOMATED
  Scenario: Normal multiple item sale in Training Mode
