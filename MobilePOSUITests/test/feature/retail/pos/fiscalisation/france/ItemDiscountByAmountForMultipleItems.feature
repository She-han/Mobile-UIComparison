Feature: Multiple item sale with an amount discount

  @PT-17366 @Fiscalisation @France @FiscalFranceMultipleItemSaleWithAmountDiscount @No_Printer @AUTOMATED
  Scenario: Multiple item sale with an amount discount
