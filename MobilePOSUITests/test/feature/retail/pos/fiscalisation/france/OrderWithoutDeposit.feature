Feature: Ordering without a deposit

  @PT-17399 @Fiscalisation @France @FiscalFranceOrder @No_Printer @AUTOMATED
  Scenario: Ordering without a deposit
    ...
    And user presses "OK" button and "Confirm Order No Deposit" page is shown
