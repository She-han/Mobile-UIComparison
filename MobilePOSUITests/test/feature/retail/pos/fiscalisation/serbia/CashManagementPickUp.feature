Feature: Cash Management - Pick up  on Serbia Fiscal Printer

  @PT-1519 @No_Printer @AUTOMATED @Serbia @Fiscalisation @FiscalSerbia
  Scenario: Verify the Fiscal Receipt for Cash Management Pickup on Serbia Fiscal Printer
