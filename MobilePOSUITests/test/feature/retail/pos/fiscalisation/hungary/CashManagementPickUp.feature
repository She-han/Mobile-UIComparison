Feature: Cash Management - Pick up
  ...
  @PT-1731 @HungaryFiscalPickUp @No_Printer @AUTOMATED @Hungary @Fiscalisation @FiscalHungary
  Scenario: Verify the Fiscal Receipt for Cash Management Pick Up on Hungary Fiscal Printer
