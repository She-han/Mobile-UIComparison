Feature: Print EJ Report - Hungary

  @PT-1783 @HungaryFiscalEJReport @No_Printer @Fiscalisation @FiscalHungary @AUTOMATED
  Scenario: Print EJ Report on Hungary Fiscal Printer
    ...
    And user presses "EJ Report" button and "Fiscal Hungary Print Report" page shown
