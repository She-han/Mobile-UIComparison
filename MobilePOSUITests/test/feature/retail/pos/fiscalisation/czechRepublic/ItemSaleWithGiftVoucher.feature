Feature: Item Sale with Gift vouchers on Czech Fiscal POS

  @PT-2225 @AUTOMATED @Czech @Fiscalisation @FiscalCzech @ManualVerification
  Scenario: Verify Item Sale with Gift vouchers on Czech Fiscal POS
    ...
    And user selects "Gift Voucher CZ" from "Selection List" list
    And user presses "OK" button and "Select Redeem Voucher Sub Type" page shown
    And user selects "CZK100" from "Selection List" list
