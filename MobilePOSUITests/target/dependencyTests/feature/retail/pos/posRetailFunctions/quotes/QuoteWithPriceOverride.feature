Feature: Create a quote with a price override and convert it

  @PT-2029 @QuoteWithPriceOverride @Quote @DevelopmentInProgress
  Scenario: Create a quote with a price override and convert it
    Given user signs on as "Pos Operator"
    When user enters "${Sku Product 1}" into "Input Box" field
    And user presses "ENT" button
    And user selects "${Sku Product 1}" from "Receipt" list
    ...
    Then "Price Override ( £50.00 to £100.00 )" is displayed in "Receipt" list
    ...
    And "Price Override ( £50.00 to £100.00 )" is displayed in "Receipt" list
    ...
    And "Price Override ( £50.00 to £100.00 )" is not displayed in "Receipt" list
    And user enters "100.00" into "Input Box" field
    And user presses "OK" button and "Transaction Basket" page shown
    Then "Price Override ( £50.00 to £100.00 )" is displayed in "Receipt" list
    ...
    And receipt display with following details
      | text | Override (£50.00 to £100.50)         |
      | item | ${Sku Product 1 Description},£100.00 |
