Feature: Add a Non Merchandise product to a quote

  @PT-2030 @NonMerchendisProductOnQuote @Quote @DevelopmentInProgress
  Scenario: Add a Non Merchandise product to a quote
    ...
    When user enters "${Non Merchandise Product 1}" into "Input Box" field
    ...
    And "${Non Merchandise Product 1 Description}" is displayed in "Receipt" list
    ...
    Then "${Sku Product 1 Description}" is displayed in "Receipt" list
    And "${Non Merchandise Product 1 Description}" is not displayed in "Receipt" list
    When user enters "${Non Merchandis Product 1}" into "Input Box" field
    And user presses "ENT" button
    ...
    Then receipt display with following details
      ...
      | item | Non Merchandise Product 1 Description},${Non Merchandise Product 1 Price} |
