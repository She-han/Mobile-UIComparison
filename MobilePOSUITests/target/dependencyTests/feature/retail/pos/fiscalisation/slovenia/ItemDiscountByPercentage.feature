Feature: Item Discount (Percentage) on Slovenia Fiscal POS

  @PT-2787 @Fiscalisation @Slovenia @AUTOMATED
  Scenario: Add an Item Discount (Percentage) and Complete Transaction on Slovenia Fiscal POS
