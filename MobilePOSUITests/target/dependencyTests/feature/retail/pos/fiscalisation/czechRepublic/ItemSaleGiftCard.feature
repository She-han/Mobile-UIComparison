Feature: Tender with Gift Card on Czech Fiscal POS

  @PT-2205 @AUTOMATED @CzechRepublic @Fiscalisation @ManualVerification
  Scenario: Complete transaction and tender with Gift Voucher on Czech Fiscal POS
