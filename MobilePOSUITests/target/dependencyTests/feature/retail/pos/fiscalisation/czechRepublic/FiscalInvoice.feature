Feature: Fiscal Invoice on Czech POS

  @PT-2223 @Fiscalisation @CzechRepublic @FiscalCzechInvoice @ManualVerification @AUTOMATED
  Scenario: Verify Czech Fiscal Invoices printed on the Czech POS
    ...
    Then "Czech Confirm Customer Details" page is shown
    When user enters "123-456" into "Tax Id" field
