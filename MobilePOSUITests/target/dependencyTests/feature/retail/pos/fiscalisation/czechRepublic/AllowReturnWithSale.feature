Feature: Allow Return an Item with Normal Retail Sale on Czech Fiscal POS

  @PT-2217  @Fiscalisation @CzechRepublic @AUTOMATED @ManualVerification
  Scenario: Verify return function is allowed to mix with an Item sale on Czech Fiscal POS
