Feature: Fiscal Receipt Copy on Czech Fiscal POS

  @PT-2221 @CzechRepublicFiscalReceiptCopy @AUTOMATED @CzechRepublic @Fiscalisation @ManualVerification
  Scenario: Validate fiscal Receipt Copy on Czech Fiscal POS
