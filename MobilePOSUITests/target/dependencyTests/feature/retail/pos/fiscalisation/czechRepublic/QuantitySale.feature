Feature: Sale with multiple quantities of an item on Czech Fiscal POS

  @PT-2206 @CzechRepublicFiscalQtySale_Cash @AUTOMATED @CzechRepublic @Fiscalisation @ManualVerification
  Scenario: Sale with multiple quantities of an item on Czech Fiscal POS
