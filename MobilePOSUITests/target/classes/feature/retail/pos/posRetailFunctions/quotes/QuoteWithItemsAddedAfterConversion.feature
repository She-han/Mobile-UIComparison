Feature: Convert to Order and add products

  @PT-2043 @TobeFixedAutTest @ConvertQuoteAddProducts @Quote @POS @AUTOMATED
  Scenario: Verify that a Quote can be converted to an Order and more products are added after the conversion
    ...
    #And user enters "xxx" into "Quote Id" field
