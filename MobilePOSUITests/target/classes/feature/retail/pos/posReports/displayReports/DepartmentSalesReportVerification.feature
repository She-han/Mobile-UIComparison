Feature: Department Sales Report Verification

  @PT-2833 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for a Selected Single Date
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
   ...
   #*******PERFORM A RETURN IN CASH - 5 POUNDS**********************
    ...
    And user presses "OK" button
    Then "Transaction Basket" page is shown 
    #*******PERFORM SALES WITH ITEMS IN AN MM GROUP - MEN'S******************
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS**********************
    And user enters "${Product 47}" into "Input Box" field
    And user presses "ENT" button
    When user presses "TOTAL" button and "Select Tender" page shown
    ...
    And user presses "Returns" button
    And user presses "Return Item" button and "Enter Return Item" page shown
    And user enters "${Product 53}" into "Input Box" field
    And user presses "ENT" button and "Select Reason" page shown
    And user selects "Item Return Alert" from "Selection List" list   
    And user presses "OK" button and "Transaction Basket" page shown    
    And user presses "TOTAL" button and "Refund Item" page shown
  ...
  @PT-2834 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for a Selected Period - Current Fiscal Period
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
    And user enters "${Product 47}" into "Input Box" field
  ...
  @PT-2835 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for a Selected Month
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
    And user enters "${Product 47}" into "Input Box" field
  ...
  @PT-2836 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for This Week
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
    And user enters "${Product 47}" into "Input Box" field
  ...
  @PT-2837 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for Today
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
    And user enters "${Product 47}" into "Input Box" field
  ...
  @PT-2838 @ManualVerification @Regression @Reports  @AUTOMATED
  Scenario: Display Department Sales Report for a Selected Date Range
    Given user signs on as "Sales Assistant"  
    #*****PERFORM SALES WITH ITEMS IN AN MM GROUP - WOMEN'S*********       
    #*****PERFORM A NORMAL CASH TRANSACTION - 10 POUNDS*************
    And user enters "${Product 47}" into "Input Box" field
