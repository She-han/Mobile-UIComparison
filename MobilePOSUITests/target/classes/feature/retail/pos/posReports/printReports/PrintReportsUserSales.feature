Feature: Print User Sales Report

  @PT-1268 @Print_Single_Date_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for a given date
  ...
  @PT-1269 @Print_Date_Range_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for range of dates
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1270 @Print_Today_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for today
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1271 @Print_Yesterday_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for yesterday
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1272 @Print_This_Week_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for this week
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1273 @Print_Last_Week_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for last week
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1274 @Print_Month_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for a given month
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
  ...
  @PT-1275 @Print_Period_User_Sales_Report @POS @AUTOMATED @Dune @Harrods @Support @Print_User_Sales_Report @Reports @POSValidatedTest @POSSet1 
  Scenario: Print User Sales Report for a given period
    Given user signs on as "Sales Assistant"
    And user presses "Management" button
    And user presses "Reports" button
    And user presses "Print Reports" button and "Print Reports Select" page shown
