Feature:  Reprinting of a fiscal invoice with multiple item

  @PT-17377 @Fiscalisation @France @FiscalFranceReprintArchive @No_Printer @AUTOMATED
  Scenario:  Reprinting of a fiscal invoice with multiple item
   ...
   When user presses "Sales" button
    ...
    When user enters "Customer 1 Name" into "Forename" field
    And user enters "Customer 1 Surname" into "Surname" field
    And user presses "OK" button
