Feature: Receipt Return in training mode

  @PT-17390 @Fiscalisation @France @FiscalFranceTrainingMode @No_Printer @AUTOMATED
  Scenario: Receipt Return in training mode
