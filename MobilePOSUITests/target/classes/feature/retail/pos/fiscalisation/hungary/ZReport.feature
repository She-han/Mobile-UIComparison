Feature: Print Z Report - Hungary

  @PT-1735 @HungaryFiscalZReport @No_Printer @Fiscalisation @FiscalHungary @AUTOMATED
  Scenario: Print Z Report on Hungary Fiscal Printer
    ...
    When user presses "Z Report" button and "Fiscal Hungary Print Report" page shown
    Then user waits "60" seconds 
