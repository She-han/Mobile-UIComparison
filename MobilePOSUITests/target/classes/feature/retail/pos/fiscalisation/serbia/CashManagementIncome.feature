Feature: Cash Management - Income on Serbia Fiscal Printer

  @PT-1515 @No_Printer @AUTOMATED @Serbia @Fiscalisation @FiscalSerbia
  Scenario: Verify the Fiscal Receipt for Cash Management Income on Serbia Fiscal Printer
