Feature: Item Sale with Card Tender on German Fiscal POS

  @PT-2149 @Fiscalisation @Germany @FiscalGermanyItemSale @AUTOMATED @ManualVerification
  Scenario: Item sale paid with card on German Fiscal POS   
    ...
    And user presses "Cards" button and "Card Tender Amount" page shown
