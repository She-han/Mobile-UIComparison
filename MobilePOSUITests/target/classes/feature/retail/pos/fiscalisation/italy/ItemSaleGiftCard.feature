Feature: Item Sale with Gift Card Tender on Italy Fiscal POS

  @PT-5733 @AUTOMATED @Italy @Fiscalisation
  Scenario: Verify Item Sale with Gift Card Tender on Italy Fiscal POS
