Feature: Cash Management - Pick up

  @PT-965 @RomaniaFiscalPickUp @No_Printer @AUTOMATED @Romania @Fiscalisation @FiscalRomania
  Scenario: Verify the Fiscal Receipt for Cash Management Pickup on Romania Fiscal Printer
    ...
    And user presses "Pickup" button and "Cash Management Select Tender Reason" page shown
