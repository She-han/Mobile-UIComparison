Feature: Complete Receipt return on Slovenia Fiscal POS and Validate the fiscal Receipt

  @PT-2283 @Fiscalisation @Slovenia @FiscalSloveniaItemReturn @AUTOMATED
  Scenario: Complete Receipt return on Slovenia Fiscal POS and Validate the fiscal Receipt
    Given user signs on as "Slovenia Fiscal Sales Assistant"
    And user enters "${Product Fiscal SI 1}" into "Input Box" field
    And user presses "ENT" button
    And "${Product Fiscal SI 1 Description}" is displayed in "Receipt" list
    ...
    When user signs on as "Slovenia Fiscal Sales Assistant"
    ...
    Then user selects "Cash SI" from "Selection List" list
    ...
    And receipt display with following details
      | text | Refund                                         |
      | item | R,${Product Fiscal SI 1 Description},-${Product Fiscal SI 1 Price} |
