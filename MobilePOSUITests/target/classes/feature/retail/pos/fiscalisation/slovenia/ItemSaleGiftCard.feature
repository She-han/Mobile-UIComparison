Feature: Item Sale with Gift Card Tender on Slovenia Fiscal POS

  @PT-2795 @AUTOMATED @Slovenia @Fiscalisation
  Scenario: Verify Item Sale with Gift Card Tender on Slovenia Fiscal POS
    ...
    And user enters "9526300801201120127" into "Input Box" field    
