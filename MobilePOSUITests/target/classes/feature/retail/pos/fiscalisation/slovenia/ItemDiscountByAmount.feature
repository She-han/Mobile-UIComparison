Feature: Item Discount on Slovenia Fiscal POS

  @PT-2783 @Fiscalisation @Slovenia @AUTOMATED
  Scenario: Complete transaction with item discounts by Amount on Slovenia Fiscal POS
