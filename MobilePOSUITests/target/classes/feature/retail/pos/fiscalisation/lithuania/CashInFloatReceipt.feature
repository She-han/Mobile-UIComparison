Feature: Print Fiscal Cash In Float Receipt - Lithuania
    
  @PT-15083 @LithuaniaFiscalReceipt @Fiscalisation @Lithuania @AUTOMATED @CashDrawer @CashIn @FloatReceipt @ManualVerification
  Scenario: Lithuania - Verify cash drawer is opening when doing cash in - float and print the float receipt
