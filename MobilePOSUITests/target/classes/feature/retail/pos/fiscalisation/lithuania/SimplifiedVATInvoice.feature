Feature: Print Simplified VAT Invoice - Lithuania
    
  @PT-15090 @LithuaniaFiscalReceipt @Fiscalisation @Lithuania @AUTOMATED @SimplifiedVATInvoice @NormalReceipt @VATInvoice @ManualVerification
  Scenario: Lithuania - Verify when printing the Simplified VAT invoice for a sale, normal receipt and VAT invoice both are printing
