Feature: Create a Quote using the Sale Menu 'Quote' button

  @PT-1947 @CreateQuote @Quote @POS @AUTOMATED @ManualVerification @POSValidatedTest @POSSet3
  Scenario: Create a Quote using the Sale Menu 'Quote' button
