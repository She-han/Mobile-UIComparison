Feature: Print Fiscal Income Receipt - Lithuania
    
  @PT-15081 @LithuaniaFiscalReceipt @Fiscalisation @Lithuania @AUTOMATED @CashDrawer @CashIn @IncomeReceipt @ManualVerification
  Scenario: Lithuania - Verify cash drawer is opening when doing cash in - income and print the income receipt
