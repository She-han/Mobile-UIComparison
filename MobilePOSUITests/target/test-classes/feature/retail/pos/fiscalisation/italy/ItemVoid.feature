Feature: Void an item on the Italy fiscal POS

  @PT-5754 @Fiscalisation @Italy @FiscalItalyItemVoid @No_Printer @AUTOMATED
  Scenario: Void an item on the Italy fiscal POS
    ...
    And user presses "ENT" button
    And user enters "${Product Fiscal IT 3}" into "Input Box" field
    And user presses "ENT" button
    When user selects "${Product Fiscal IT 2 Description}" from "Receipt" list
