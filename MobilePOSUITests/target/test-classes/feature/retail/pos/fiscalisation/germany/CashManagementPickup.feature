Feature: Cash Management Pickup on German Fiscal POS

  @PT-2186 @AUTOMATED @Germany @Fiscalisation @FiscalGermany @ManualVerification
  Scenario: Verify the Fiscal Receipt for Cash Management Pickup on German Fiscal POS   
