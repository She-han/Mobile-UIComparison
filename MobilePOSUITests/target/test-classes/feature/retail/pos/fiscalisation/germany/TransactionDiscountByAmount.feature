Feature: Transaction Discount as an amount on German Fiscal POS

  @PT-2177 @Fiscalisation @Germany @FiscalGermanyTransactionDiscountAmount @AUTOMATED @ManualVerification
  Scenario: Transaction Discount as an amount on German Fiscal POS
    ...
    And "-€3.00" is displayed in "Receipt" list
