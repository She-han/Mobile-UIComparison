Feature: CashManagement DayStart and InitialFloat on German Fiscal POS

  @PT-2181 @AUTOMATED @Germany @Fiscalisation @FiscalGermany @ManualVerification
  Scenario: Verify the Fiscal Receipt for Cash Management Day Start and Initial Float on German Fiscal POS
