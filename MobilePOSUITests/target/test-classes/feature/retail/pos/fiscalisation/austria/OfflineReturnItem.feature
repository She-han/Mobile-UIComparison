Feature: Return Item Offline Mode

  @PT-642 @Offline_Item_Return @No_Printer @Austria @AUTOMATED @Fiscalisation @FiscalAustria
  Scenario: Return an Tax Eligible Item in Offline Mode
