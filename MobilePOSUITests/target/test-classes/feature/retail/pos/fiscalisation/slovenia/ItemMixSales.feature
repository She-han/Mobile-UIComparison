Feature: Verify Item Mix Sales on Slovenia Fiscal POS

  @PT-2788 @Fiscalisation @Slovenia @FiscalSloveniaItemSalewithMixTenders @AUTOMATED 
  Scenario: Verify Item Mix Sales on Slovenia Fiscal POS
