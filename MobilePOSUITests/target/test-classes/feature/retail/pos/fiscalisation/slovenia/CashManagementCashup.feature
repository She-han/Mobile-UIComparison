Feature: Verify the Fiscal Receipt for Cash Management Cash up on Slovenia Fiscal Printer

  @PT-2803 @SloveniaFiscalCashup @No_Printer @AUTOMATED @Slovenia @Fiscalisation @FiscalSlovenia
  Scenario: Verify the Fiscal Receipt for Cash Management Cash up on Slovenia Fiscal Printer
