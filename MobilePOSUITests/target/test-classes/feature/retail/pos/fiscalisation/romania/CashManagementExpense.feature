Feature: Cash Management - Expense
  ...
  @PT-968 @RomaniaFiscalExpense @No_Printer @AUTOMATED @Romania @Fiscalisation @FiscalRomania
  Scenario: Verify the Fiscal Receipt for Cash Management Expenses on Romania Fiscal Printer
    ...
    And user presses "Expense" button and "Cash Management Select Tender Reason" page shown
