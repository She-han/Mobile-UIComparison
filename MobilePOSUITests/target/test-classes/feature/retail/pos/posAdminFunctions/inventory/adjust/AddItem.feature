...
Feature: Add Item Page 

	@PT-13019 @INVENTORY @POS @AUTOMATED
    ...
    @PT-13020 @INVENTORY @POS @AUTOMATED
    Scenario: Add button saves the quantity entered and navigates back to Adjustment Items Page 
	...
	@PT-13021 @INVENTORY @POS @AUTOMATED
	Scenario: Cancel button goes back to Adjustment Items Page with no changes
		...
		And user presses "Cancel" button and "Adjustment Items" page shown
		And "${Product 123as3y-11}" is not displayed in "Adjustment Items List" list
