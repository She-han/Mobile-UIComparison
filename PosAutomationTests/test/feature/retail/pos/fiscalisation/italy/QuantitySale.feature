Feature: Quantity Sale on Italy Fiscal POS

  @PT-5734 @Fiscalisation @Italy @FiscalQuanitySale @AUTOMATED @ManualVerification
  Scenario: Verify Quantity Sale on Italy Fiscal POS
