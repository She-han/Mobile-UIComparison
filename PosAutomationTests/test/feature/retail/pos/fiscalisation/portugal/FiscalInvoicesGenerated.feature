Feature: Verify Mixing Fiscal Invoices generated on Portugal Fiscal POS

  @PT-5015 @Portugal @AUTOMATED @Fiscalisation @ManualVerification
  Scenario: Verify Mixing Fiscal Invoices generated on Portugal Fiscal POS
    ...
    And user enters "112" into "Tax Id" field
